...
from utils import get_sb, require_auth, require_role, current_username, audit, fmt, load_inventory, moving_avg_landed_cost, can, ROLE_COLORS, current_user, current_role, logout

st.set_page_config(page_title="Inventory — Duka", page_icon="◫", layout="wide", menu_items=None)
inject()
require_auth()
