...
from utils import get_sb, require_auth, current_username, audit, fmt, can, current_user, current_role, logout, ROLE_COLORS

st.set_page_config(page_title="POS — Duka", page_icon="◈", layout="wide", menu_items=None)
inject()
require_auth()
